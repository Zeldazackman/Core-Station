...
/mob/living/simple_mob/animal/passive/pokemon
	...
	icon = 'modular_arfs/icons/mob/mobs/pokemon.dmi'
	pixel_x = -16
	default_pixel_x = -16
	old_x = -16
	health = 100
...
/mob/living/simple_mob/animal/passive/pokemon/Initialize()
	...
	heal_layer = image("icon" = 'modular_arfs/icons/mob/mobs/pokemon_effects.dmi', "icon_state" = "green_sparkles")
...
/mob/living/simple_mob/animal/passive/pokemon/leg
	icon = 'modular_arfs/icons/mob/mobs/legendary.dmi'
	pixel_x = -32
	default_pixel_x = -32
	old_x = -32
	health = 200
